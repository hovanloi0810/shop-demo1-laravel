...
<div class="row mt">
    <div class="col-lg-12">
      <h4 class="title"><i class="fa fa-angle-right"></i>Add Supplier</h4>
      ...
      <form class="contact-form php-mail-form" role="form" action="{{URL::to ('/save-supplier') }}" method="POST">

        {{ csrf_field() }}  {{-- tạo token cho trang website => bao mat hon >< mysql injection --}}


        <div class="form-group">
            <input type="text" name="supplier_name" class="form-control" id="contact-name" placeholder="Supplier Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
            <div class="validate"></div>
        </div>


        <div class="form-group">
            <input type="text" name="supplier_amuont" class="form-control" id="contact-name" placeholder="Supplier Amuont" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
            <div class="validate"></div>
        </div>
        ...
        <div class="form-group">
            <input type="text" name="supplier_price" class="form-control" id="contact-name" placeholder="Supplier Price" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
            <div class="validate"></div>
        </div>
        ...
        <div class="form-group">
            <input type="text" name="supplier_product" class="form-control" id="contact-name" placeholder="Supplier Product" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
            <div class="validate"></div>
        </div>
        ...
        <select class="form-control" name="supplier_status">
          ...
          <div class="form-send">
            <button type="submit" name="add_supplier" class="btn btn-large btn-primary">Add Supplier</button>
          </div>

...
<div class="row mt">
    <div class="col-lg-12">
      <h4 class="title"><i class="fa fa-angle-right"></i>Add Category Product</h4>
      ...
      {{-- action="{{URL::to ('/save-category-product')}} => chuyển về routes '/save-category-product'--}}
      <form class="contact-form php-mail-form" role="form" action="{{URL::to ('/save-category-product') }}" method="POST">

        {{ csrf_field() }}  {{-- tạo token cho trang website => bao mat hon >< mysql injection --}}


        <div class="form-group">
          <input type="text" name="category_product_name" class="form-control" id="contact-name" placeholder="Category Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
        ...
        <select class="form-control" name="category_product_status">
          ...
          <div class="form-send">
            <button type="submit" name="add_category_product" class="btn btn-large btn-primary">Add Category</button>
          </div>

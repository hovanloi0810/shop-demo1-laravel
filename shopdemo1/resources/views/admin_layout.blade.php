...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="{{URL::to ('/dashboard') }}" class="logo"><b>DASH<span>IO</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="{{asset ('public/backend/img/ui-zac.jpg') }}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="{{asset ('public/backend/img/ui-divya.jpg') }}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="{{asset ('public/backend/img/ui-danro.jpg') }}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="{{asset ('public/backend/img/ui-sherman.jpg') }}"></span>
                  <span class="subject">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
            {{-- {{URL::to ('/logout') }} => toi /logout trong routes --}}
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="{{asset ('public/backend/img/ui-sam.jpg') }}" class="img-circle" width="80"></a></p>
          <h5 class="centered">

                {{-- in ra admin_name --}}
              @php
                  $name = session()->get('admin_name'); //lấy admin_name từ AdminController => function dashboard()
                                                        //session()->get == Session::get
                  if ($name) { //nếu $name tồn tại
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                ...
                {{-- {{URL::to ('/add-category-product') }} => chuyển về routes ->'/add-category-product'--}}
              <li><a href="{{URL::to ('/add-category-product') }}">Add Category Product</a></li>

              {{-- {{URL::to ('/all-category-product') }} => chuyển về routes -> '/all-category-product'--}}
              <li><a href="{{URL::to ('/all-category-product') }}">Listed Category Product</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              {{-- {{URL::to ('/add-brand-product') }} => chuyển về routes ->'/add-brand-product' --}}
              <li><a href="{{URL::to ('/add-brand-product') }}">Add Brand Product</a></li>

              {{-- {{URL::to ('/all-brand-product') }} => chuyển về routes ->'/all-brand-product' --}}
              <li><a href="{{URL::to ('/all-brand-product') }}">Listed Brand Product</a></li>
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <ul class="sub">
                ...
                {{-- {{URL::to ('/all-brand-product') }} => chuyển về routes ->'/all-brand-product' --}}
                <li><a href="{{URL::to ('/all-product') }}">Listed Product</a></li>
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12 main-chart">
            <!--CUSTOM CHART START -->
            @yield('admin_content') <!--goi lai section trong dashboard.blade.php -->
                ...
                {{-- <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="{{asset ('public/backend/img/ui-danro.jpg') }}" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
            ...
            <div class="row">
              ...
              {{-- <div class="col-md-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img src="{{asset ('public/backend/img/ui-zac.jpg') }}" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
                    <div class="col-md-6">
          ...
          {{-- <div class="col-lg-3 ds">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset ('public/backend/img/ui-divya.jpg') }}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset ('public/backend/img/ui-sherman.jpg') }}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset ('public/backend/img/ui-danro.jpg') }}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset ('public/backend/img/ui-zac.jpg') }}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        image: '{{asset ('public/backend/img/ui-sam.jpg') }}',

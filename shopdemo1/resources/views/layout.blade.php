...
<head>
    ...
    <link href="{{asset ('public/frontend/css/bootstrap.extension.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('public/frontend/css/style.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('public/frontend/css/swiper.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('public/frontend/css/sumoselect.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-xs-3 col-sm-1">
                            <a id="logo" href="{{URL::to ('/trang-chu') }}"><img src="{{ ('public/frontend/img/logo-2.png') }}" alt="" /></a>
                        </div>
                            ...
                            <div class="slider-product-preview">
                                <div class="product-preview-shortcode">
                                    <div class="preview">
                                        ...
                                        <div class="entry full-size swiper-lazy active" data-background="{{ ('public/frontend/img/product-preview-1.jpg') }}"></div>
                                        <div class="entry full-size swiper-lazy" data-background="{{ ('public/frontend/img/product-preview-2.jpg') }}"></div>
                                        <div class="entry full-size swiper-lazy" data-background="{{ ('public/frontend/img/product-preview-3.jpg') }}"></div>
                                    </div>
                                    <div class="sidebar valign-middle" data-swiper-parallax-x="-300">
                                        <div class="valign-middle-content">
                                            <div class="entry active"><img src="{{ ('public/frontend/img/product-4.png') }}" alt="" /></div>
                                            <div class="entry"><img src="{{ ('public/frontend/img/product-5.png') }}" alt="" /></div>
                                            <div class="entry"><img src="{{ ('public/frontend/img/product-6.png') }}" alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{asset ('public/frontend/js/swiper.jquery.min.js') }}"></script>
    <script src="{{asset ('public/frontend/js/global.js') }}"></script>

    <!-- styled select -->
    <script src="{{asset ('public/frontend/js/jquery.sumoselect.min.js') }}"></script>
...
<!-- Mirrored from unionagency.one/exzo/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Nov 2020 02:45:55 GMT -->
</html>
